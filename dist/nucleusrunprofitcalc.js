...
function Main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (molePetLevelValue > 100)
            molePetLevelValue = 100;
        if (daemonShardLevelValue > 10)
            daemonShardLevelValue = 10;
        if (molePetLevelValue < 0)
            molePetLevelValue = 0;
        if (daemonShardLevelValue < 0)
            daemonShardLevelValue = 0;
